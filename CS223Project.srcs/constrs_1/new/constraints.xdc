...
#set_property PACKAGE_PIN R3 [get_ports {R}] 	 	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {R}] 
#set_property PACKAGE_PIN T2 [get_ports {L}] 	 	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {L}] 



# LEDs 
set_property PACKAGE_PIN U16 [get_ports {TXBUF[0]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {TXBUF[0]}] 
set_property PACKAGE_PIN E19 [get_ports {TXBUF[1]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {TXBUF[1]}] 
set_property PACKAGE_PIN U19 [get_ports {TXBUF[2]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {TXBUF[2]}] 
set_property PACKAGE_PIN V19 [get_ports {TXBUF[3]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {TXBUF[3]}] 
set_property PACKAGE_PIN W18 [get_ports {TXBUF[4]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {TXBUF[4]}] 
set_property PACKAGE_PIN U15 [get_ports {TXBUF[5]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {TXBUF[5]}] 
set_property PACKAGE_PIN U14 [get_ports {TXBUF[6]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {TXBUF[6]}] 
set_property PACKAGE_PIN V14 [get_ports {TXBUF[7]}]  	 	 	 	 
...
set_property PACKAGE_PIN U17 [get_ports transmit]  	 	 	 	 	 
